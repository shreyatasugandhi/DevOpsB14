...
Feature: Login functionality
  ...
  @regression
  Scenario Outline: As a user when I enter invalid userid and password into application application should give me error message in order to validate authentication 
    Given I am on login page
    When I enter user id as "<username>" and password as "<password>"
    And Click on Signin button
